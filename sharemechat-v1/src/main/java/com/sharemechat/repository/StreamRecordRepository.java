...
public interface StreamRecordRepository extends JpaRepository<StreamRecord, Long> {
    ...
    long countByEndTimeIsNullAndStreamTypeAndConfirmedAtIsNull(String streamType);
    long countByEndTimeIsNullAndStreamTypeAndConfirmedAtIsNotNull(String streamType);
