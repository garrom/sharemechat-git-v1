...
Este fichero recoge respuestas breves a las preguntas más comunes de 
los usuarios. Para información detallada, consulta los ficheros 
correspondientes.
...
1-a-1 en tiempo real. Ver 01-producto.md.
...
A través de Didit, especialista en verificación de identidad. Ver 
02-onboarding-cliente.md o 03-onboarding-modelo.md.

## Sobre precios y pagos

**¿Cuánto cuesta?**
1 EUR por minuto de videochat. Sin cargos ocultos, sin suscripciones. 
Ver 05-pagos-y-saldo.md.
...
mutuo, puedes iniciar sesión directa. Ver 04-chat-y-favoritos.md.
...
Ver 06-moderacion-y-seguridad.md.

**¿Cómo bloqueo a otro usuario?**
Desde la lista de favoritos o durante videochat. Ver 
04-chat-y-favoritos.md.
...
Ver 09-empresa-y-contacto.md. Este Agente IA está disponible 24/7. 
...
- Este fichero es referencia rápida. Cuando un usuario pregunta, tu 
  respuesta debe ser conversacional (no como FAQ formal), adaptada al 
  usuario y con la profundidad adecuada.

- Si una pregunta no está aquí, buscar en el fichero temático 
  correspondiente y responder desde tu conocimiento general.
...
- Este fichero se mantendrá vivo: cuando el equipo detecte preguntas 
  frecuentes reales de usuarios que no estén aquí, se irán añadiendo.
