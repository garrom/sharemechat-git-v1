...
**Regla crítica**: no se despliega saltándose el check de drift. Está ahí por el incidente del 2026-06-08 (frontend con `productAccessMode` sobre backend 9 días anterior → MODEL y CLIENT viendo solo header y footer); su historia vive en [`docs/_archive/04-operations/incident-notes.md`](docs/_archive/04-operations/incident-notes.md).
