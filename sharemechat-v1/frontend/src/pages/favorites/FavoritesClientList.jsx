    ...
    >
      ...
      <button
        ...
        onClick={(e) => {
          ...
          // Tomamos el rectángulo de la tarjeta completa
          ...
          const menuWidth = 220; // aprox ancho del menú
          let x = rect.left;
          // evitamos que se salga por la derecha
          if (x + menuWidth > vw - 8) {
            x = vw - menuWidth - 8;
          }

          const y = rect.bottom + 4; // justo debajo de la tarjeta
