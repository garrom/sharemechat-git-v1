...
**#D-26 — T&C y contrato de modelo v5 con política de descuentos ADR-052 §D7 — BORRADOR CLAUSULAS REDACTADO 2026-07-25; PENDIENTE INTEGRAR EN v5 COMPLETO Y DECISIONES DEL OPERADOR SOBRE VALORES**. La política de responsabilidad económica introducida por [ADR-052 §D7](../06-decisions/adr-052-rediseno-reparto-precio-y-retirada-afiliadas.md) — descuentos automáticos del payout siguiente por chargebacks/refunds/sanciones PSP atribuibles, umbral de suspensión ~5% chargebacks/mes, derecho a disputa con evidencia, transparencia total en panel de la modelo — necesita **materializarse en T&C y contrato de modelo** (v5) con consentimiento explícito de la modelo al firmar. Sin ese consentimiento formal, un descuento aplicado sin autorización previa es disputable legalmente. **Estado actual**: borrador textual de las 6 cláusulas nuevas (X.1 a X.6) redactado en [`../01-business/model-contract-v5-clauses-d7-draft.md`](../01-business/model-contract-v5-clauses-d7-draft.md) en versión ES + EN por el asistente el 2026-07-25 a petición explícita del operador (decisión operador: no se contratará asesoría legal externa; el operador asume la responsabilidad del texto final). El borrador incluye 7 decisiones pendientes del operador que calibran valores concretos (umbral chargebacks 5%, ventana notificación 7 días, SLA disputa 10 días hábiles, arrastre 90 días, reincidencia 3 en 12m, cláusula reserva del 5% opcional no incluida, jurisdicción). **Pendiente residual**: (a) operador confirma valores de las 7 decisiones; (b) refactor del Model Contract v4 completo integrando estas cláusulas (cubre deudas R5 + G4 del bloque 2026-06-27); (c) sistema técnico distingue causa de cierre de sesión (cliente/modelo/técnico) para atribuir descuentos por "cancelación unilateral" — deuda técnica implícita expuesta por el borrador; (d) cablear "payout paralizado por review" en PayoutRequest para materializar la suspensión de la Cláusula X.3. **Bloqueante** para desplegar D9 (descuentos automáticos) sin exposición legal. Alineado con la deuda R5 "Model Collaboration Agreement v5 con lenguaje nuevo" ya declarada en el bloque de 2026-06-27 (esta deuda #D-26 refina el scope de R5 con los requisitos económicos concretos de ADR-052). **Prioridad**: alta pre-materialización del Sub-frente 3 del Frente 3 (implementación técnica del reparto).
