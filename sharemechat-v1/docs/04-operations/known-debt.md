...
**#D-24 — Rediseño de packs de recarga premium para modelos T2/T3**. Los packs vigentes (10 / 20 / 40 €) están calibrados para tarifas cercanas a €1/min (T0). Con el rango de precio autoservicio introducido por [ADR-052 §D2](../06-decisions/adr-052-rediseno-reparto-precio-y-retirada-afiliadas.md) (1-9 €/min según tramo), una modelo T3 con tarifa €9/min consume el pack de 10 € en poco más de 1 minuto y el pack de 40 € en ~4,5 minutos. El cliente que quiera consumir varios minutos con una modelo T3 tiene que comprar varios packs consecutivos. Rediseño de packs premium (importes más altos como 100 € / 250 € / 500 €) queda declarado como frente separado; no es scope de ADR-052. **Impacto**: fricción de conversión en el extremo alto del rango de precio. **Prioridad**: media (baja mientras haya pocas modelos T2/T3 activas; sube a alta cuando haya volumen sostenido en tramos altos y se detecte pérdida de conversión). **Referencia**: [`../01-business/pricing.md`](../01-business/pricing.md) sección "Fricción conocida entre rango de precio y packs vigentes".

**#D-25 — Recalibración del modelo financiero (`modelo-financiero.md` + xlsx) con nuevo reparto 75-79%**. La proyección numérica mes a mes y el horizonte de break-even documentados en [`../01-business/financiero/modelo-financiero.md`](../01-business/financiero/modelo-financiero.md) asumen el sistema de tiers previo (reparto 15-40% modelo según tier `5-15/7-20/9-40`, tarifa plana €1/min, CardBilling / Verotel al 10% + €0.30). Todo eso quedó superseded por [ADR-052](../06-decisions/adr-052-rediseno-reparto-precio-y-retirada-afiliadas.md): reparto 75-79% escalonado, rango de precio autoservicio 1-9 €/min, fees PSP aproximados NOWPayments ~1% cripto + ~13% tarjeta (aproximación conservadora hasta que el PSP tarjeta cierre contrato). Es previsible que el horizonte de break-even se aleje significativamente respecto al modelo previo (margen unitario delgado); el ADR asume esta consecuencia como coste del reclutamiento agresivo. **Impacto**: el `.md` y el `.xlsx` de referencia comercial y de decisión del operador quedan desalineados con la línea económica vigente. **Prioridad**: media (bloqueante para decisiones estratégicas de mes 3 / mes 6 basadas en el modelo financiero). El xlsx es binario y requiere manipulación manual del operador; el .md se puede pre-cablear con las nuevas fórmulas y dejar los rangos comentados hasta que el operador confirme los datos.

**#D-26 — T&C y contrato de modelo v5 con política de descuentos ADR-052 §D7**. La política de responsabilidad económica introducida por [ADR-052 §D7](../06-decisions/adr-052-rediseno-reparto-precio-y-retirada-afiliadas.md) — descuentos automáticos del payout siguiente por chargebacks/refunds/sanciones PSP atribuibles, umbral de suspensión ~5% chargebacks/mes, derecho a disputa con evidencia, transparencia total en panel de la modelo — necesita **materializarse en T&C y contrato de modelo** (v5) con consentimiento explícito de la modelo al firmar. Sin ese consentimiento formal, un descuento aplicado sin autorización previa es disputable legalmente. Coordinación con asesoría legal externa adult-experienced. **Bloqueante** para desplegar D9 (descuentos automáticos) sin exposición legal. Alineado con la deuda R5 "Model Collaboration Agreement v5 con lenguaje nuevo" ya declarada en el bloque de 2026-06-27 (esta deuda #D-26 refina el scope de R5 con los requisitos económicos concretos de ADR-052). **Prioridad**: alta pre-materialización del Sub-frente 3 del Frente 3 (implementación técnica del reparto).
