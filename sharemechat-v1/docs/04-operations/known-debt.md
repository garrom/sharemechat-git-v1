...
**#D-24 — Rediseño de packs de recarga premium para modelos T3/T4**. Los packs vigentes (10 / 20 / 40 €) están calibrados para tarifas cercanas a €1/min (T1). Con el rango de precio autoservicio introducido por [ADR-052 §D2](../06-decisions/adr-052-rediseno-reparto-precio-y-retirada-afiliadas.md) (1-9 €/min según tramo), una modelo T4 con tarifa €9/min consume el pack de 10 € en poco más de 1 minuto y el pack de 40 € en ~4,5 minutos. El cliente que quiera consumir varios minutos con una modelo T4 tiene que comprar varios packs consecutivos. Rediseño de packs premium (importes más altos como 100 € / 250 € / 500 €) queda declarado como frente separado; no es scope de ADR-052. **Impacto**: fricción de conversión en el extremo alto del rango de precio. **Prioridad**: media (baja mientras haya pocas modelos T3/T4 activas; sube a alta cuando haya volumen sostenido en tramos altos y se detecte pérdida de conversión). **Referencia**: [`../01-business/pricing.md`](../01-business/pricing.md) sección "Fricción conocida entre rango de precio y packs vigentes".
