...
- endpoints SEO sin auth (Frente 2 sobre Fase 4A) — operativos end-to-end (CloudFront → nginx → Spring Boot):
  ...
  - detalle de la reaplicación coordinada en [incident-notes.md](docs/_archive/04-operations/incident-notes.md) sección "Routing /sitemap.xml y /robots.txt en CloudFront TEST"
