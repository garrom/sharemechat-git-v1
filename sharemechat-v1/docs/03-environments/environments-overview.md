...
- **PROD prelaunch**: modo `PRELAUNCH` con registros configurables, en principio abiertos para captación de Fase 1 del roadmap. Pendiente de validación operativa antes de activarse en PROD.
- **PROD normal**: modo `OPEN` con registros abiertos.
