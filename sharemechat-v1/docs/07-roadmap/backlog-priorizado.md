...
| **Reconciliar docs obsoletos** | 🟢 en curso (2026-08-29) | Consolidación del roadmap: `backlog-priorizado.md` queda como **única** fuente de estado; `current-phase.md`, `pending-hardening.md` y `go-live-roadmap.md` se vacían de estado / archivan (rescatando al backlog lo que siga vivo). | este backlog es el ancla |
