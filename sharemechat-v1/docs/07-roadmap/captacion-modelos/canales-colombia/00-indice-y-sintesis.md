...
| 6 | **TikTok (social, CON LOGIN)** — el canal estrella | [`tiktok.md`](tiktok.md) |

> **Actualización 2026-09-03 (3ª tanda SONDA — social CON LOGIN):** con cuenta de trabajo
> logueada (perfil de Chrome dedicado + Claude-en-Chrome) se investigó X y TikTok en vivo.
> **Resultado: TikTok es EL canal** (estudios activos, audiencias de 17K-32K followers, funnel
> vídeo→smartlink→WhatsApp) y **X es marginal** (estudios muertos, ~2 posts vivos, filtro de
> sensibilidad ocultando material). Detalle en [`tiktok.md`](tiktok.md) y bloque "con login" de
...
| **X (social)** | **CON LOGIN (2026-09-03): canal MARGINAL.** Estudios muertos (@studioseduccion 0 posts/4 followers), ~2 posts vivos bajo #modelowebcam, 1 anuncio real (SATOR/Cali, WhatsApp quemado en imagen), filtro de sensibilidad ocultando material. Audiencia 37-122 followers. (1ª tanda sin login: 402 en todo; nitter muerto.) |
| **TikTok (social)** | **CON LOGIN (2026-09-03): EL CANAL.** Denso y vivo: Master studios 2.686 likes, SM LIVE 996, SF studio "70%/6 horitas", dreamhouse (32,5K followers, Bogotá), xstudioscol (17K, Medellín)… Playbook #modelowc/"desde casa"/"sin experiencia". Funnel vídeo→smartlink→**WhatsApp**+"Agenda DreamTalk". Aquí vive el público de aspirantes. |

## Hallazgos transversales (datos, no recomendaciones)

1. **Todo el reclutamiento visible lo hacen ESTUDIOS, no la relación directa.** En bolsas, X y TikTok, quien aparece captando es el **estudio intermediario** (con marca), no la modelo suelta ni la plataforma. La captación DIRECTA plataforma→modelo **no tiene presencia visible**: nadie recluta "en crudo" como individuo ni como plataforma-destino. Implica que, para entrar, SharemeChat debe **hablar el idioma del canal** (marca ligera de estudio) — ver [`tiktok.md`](tiktok.md) §5 y [`como-publicar.md`](como-publicar.md). (DATO DURO — bolsas + X/TikTok con login.)
...
- **El canal social es TikTok, no X** (verificado con login). TikTok tiene estudios activos, audiencias de 17K-32K y un funnel probado (vídeo→smartlink→WhatsApp); X es marginal. Ver [`tiktok.md`](tiktok.md).
- El público objetivo (**aspirantes principiantes**, segmento del debate A6) **está en TikTok** viendo este contenido en volumen; la chica-con-audiencia-propia vive en TikTok/IG/OF a otra escala (Karina García 5,7M) — descartada por ahora.
- Las **bolsas de empleo** sirven de complemento, pero son sobre todo **puerta de estudios** (elempleo el más usado); usarlas para captación DIRECTA implicaría **publicar tú un anuncio** (no rastrear), con el playbook de eufemismos.
- **Ventaja diferencial de SharemeChat** (a validar en fase de mensaje, nudo 1): reclutar para **la propia plataforma** en vez de mandar a "páginas internacionales" de terceros = más limpio y mejor compliance.
...
- **Vigencia hoy** de estudios/ofertas de bolsas (varios de 2017-2022).
- **Eufemismos no probados** que puedan esconder oferta bajo términos no obvios en páginas profundas.
- **Con login (X/TikTok):** no se leyeron comentarios/DMs (dónde preguntan las aspirantes) ni conversaciones de WhatsApp → el "sí quiero" real y la conversión no están medidos; contenido +18 más explícito pudo quedar oculto por el filtro de sensibilidad de la cuenta. Ver "Lo que NO se verificó" de [`tiktok.md`](tiktok.md).
