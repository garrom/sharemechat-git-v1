...
> Plan histórico y operativo del entorno AUDIT. Se mantiene como referencia del patrón ya validado y como **entorno de validación externa y patrón operativo** previo a PROD. En el roadmap principal ([go-live-roadmap.md](go-live-roadmap.md)) AUDIT es el banco de pruebas natural para validaciones de Fase 3 (PSP CCBill) y para cualquier validación end-to-end previa a apertura PROD.
