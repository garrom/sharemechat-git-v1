...
- **Gifts (ya NO amplifican).** Corrección 2026-08-16: los gifts **dejaron de repartir un 90 % fijo**. Desde [ADR-056 revisión 2026-08-01](../06-decisions/adr-056-sistema-master-studio.md) aplican **el mismo tramo que los minutos** (`ModelTierService`, 50-70 % según INDIVIDUAL/MASTER T1-T4; ~50 % en T1 de apertura). Por tanto, que el bono se gaste en gifts en vez de en minutos **ya no encarece la promo** respecto al cálculo caja-neutral: ambos reparten ~50 % en T1. *(La versión previa de esta nota asumía gifts al 90 % — información antigua, eliminada; ese "amplificador" ya no existe.)*
