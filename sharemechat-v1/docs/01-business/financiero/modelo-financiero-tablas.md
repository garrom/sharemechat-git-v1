...
**Contenido pendiente de revisión (Fase B):** las tablas y supuestos siguen asumiendo CardBilling / Verotel como PSP activo, F1 Coming Soon mes 0-3 sin revenue, **y reparto 15-40% modelo (sistema de tiers previo)**. Estas premisas quedan invalidadas por (a) [ADR-047](../../06-decisions/adr-047-pivote-soft-launch-cripto-paxum.md) (soft launch cripto + Paxum desde mes 1), (b) [ADR-052](../../06-decisions/adr-052-rediseno-reparto-precio-y-retirada-afiliadas.md) (reparto 75-79% con umbrales 3.500/5.000/6.500, ahora también superseded), y (c) [ADR-056 §D3](../../06-decisions/adr-056-sistema-master-studio.md) (reparto vigente 50-60% con umbrales 1.000/4.000/15.000). La actualización numérica de estas tablas corresponde a la recalibración del xlsx pendiente del operador (ver [`modelo-financiero.md`](modelo-financiero.md) §7). Se conserva el contenido tal como estaba en el Excel para no perder la traza histórica.
