...
Marco paramétrico para razonar sobre el margen de contribución por transacción en SharemeChat. Este documento **no fija cifras cerradas**: enumera las variables que componen el margen y deja como parámetros abiertos las que todavía no están decididas. Se actualizará cuando CardBilling / Verotel cierre tarifas y cuando el reparto modelo/plataforma quede formalizado.
...
**Pendiente de cierre de tarifas con CardBilling / Verotel.** La vía activa de onboarding es CardBilling / Verotel (condicional, en due diligence) según [psp-strategy.md](psp-strategy.md), pero no hay contrato firmado y, por tanto, no hay tarifa cerrada que aplicar. Una vez CardBilling / Verotel confirme, la comisión del PSP se descompondrá típicamente en:
...
- **comisión PSP** queda pendiente del cierre de tarifas con CardBilling / Verotel.
...
Una **proyección numérica preliminar** del margen mes a mes y del horizonte de break-even, asumiendo valores estándar del sector adulto para CardBilling / Verotel (10% + €0.30/TX + 1% chargebacks × €25) y los demás supuestos vigentes, está incorporada en [financiero/modelo-financiero.md](financiero/modelo-financiero.md). Esa proyección se sustituirá por cifras cerradas cuando CardBilling / Verotel firme contrato y se formalice la política de payouts, momento en que el documento se actualizará.

## Estado de este documento

Documento **paramétrico y abierto**. Se completará en dos hitos:

1. **Cuando CardBilling / Verotel cierre comisiones**: se sustituye el placeholder de comisión PSP por las tarifas reales (fija, variable, reservas, fees adicionales).
...
- [psp-strategy.md](psp-strategy.md) — estrategia de PSP (CardBilling / Verotel como vía activa).
