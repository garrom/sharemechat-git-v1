...
- **Segpay**: vía activa de onboarding, **condicional**. Comunicación abierta, due diligence en curso. Sin contrato firmado al cierre de este documento. La continuidad con Segpay depende de que su equipo de compliance acepte el método de verificación de edad de cliente decidido por el producto (estimación facial vía Didit + comprobación secundaria solo para casos borderline; arquitectura original en [ADR-029](../06-decisions/adr-029-age-and-identity-verification-architecture.md), consolidación en [ADR-035](../06-decisions/adr-035-age-and-identity-verification-vendor-consolidation-on-didit.md)). Si Segpay exige documento de identidad para el 100% de los consumidores, no se continúa con Segpay y se activa el plan B descrito más abajo.
