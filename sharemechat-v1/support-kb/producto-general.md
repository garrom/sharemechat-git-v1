---
case_key: producto-general
role: BOTH
active: true
description: Producto y preguntas frecuentes generales
---
...
- Canal público de denuncias sin sesión: /complaint. Es EXCLUSIVAMENTE para moderación, seguridad, contenido ilegal, incidentes entre usuarios o suplantación de identidad. NO aplica a cuestiones económicas (pagos, packs, payout, tiers, umbrales, disputas de saldo), gestión de cuenta, soporte funcional ni excepciones operativas. Para eso, escalado humano por este mismo chat.
