...
WORK_ROOT="${WORK_ROOT:-/var/lib/sharemechat-test-access-blocker}"
OUTPUT_ROOT="${OUTPUT_ROOT:-/var/log/sharemechat-test-access-blocker}"
...
NGINX_DENY_FILE="${NGINX_DENY_FILE:-/etc/nginx/deny-test-ips.conf}"
...
NGINX_MANUAL_DENY_FILE="${NGINX_MANUAL_DENY_FILE:-/etc/nginx/deny-test-ips.manual.conf}"
