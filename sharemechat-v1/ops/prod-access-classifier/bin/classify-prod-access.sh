...
WORK_ROOT="${WORK_ROOT:-/var/lib/sharemechat-prod-access-classifier}"
OUTPUT_ROOT="${OUTPUT_ROOT:-/var/log/sharemechat-prod-access-classifier}"
NORMALIZED_ROOT="${NORMALIZED_ROOT:-/var/log/sharemechat-prod-access-normalizer}"
