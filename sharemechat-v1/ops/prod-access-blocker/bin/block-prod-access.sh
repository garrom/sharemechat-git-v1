...
WORK_ROOT="${WORK_ROOT:-/var/lib/sharemechat-prod-access-blocker}"
OUTPUT_ROOT="${OUTPUT_ROOT:-/var/log/sharemechat-prod-access-blocker}"
CLASSIFIER_OUTPUT_ROOT="${CLASSIFIER_OUTPUT_ROOT:-/var/log/sharemechat-prod-access-classifier}"
...
NGINX_DENY_FILE="${NGINX_DENY_FILE:-/etc/nginx/deny-prod-ips.conf}"
...
NGINX_MANUAL_DENY_FILE="${NGINX_MANUAL_DENY_FILE:-/etc/nginx/deny-prod-ips.manual.conf}"
