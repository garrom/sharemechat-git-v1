...
WORK_ROOT="${WORK_ROOT:-/var/lib/sharemechat-audit-access-classifier}"
OUTPUT_ROOT="${OUTPUT_ROOT:-/var/log/sharemechat-audit-access-classifier}"
NORMALIZED_ROOT="${NORMALIZED_ROOT:-/var/log/sharemechat-audit-access-normalizer}"
